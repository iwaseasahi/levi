...
| Complete-body projection and acknowledged blank control                                         | `slide-projection.spec.ts`, lifecycle E2E, projection component/transport tests. Slide projection exposes no transient font controls; Scripture retains the shared transport font-scale responsibility.                                                                                                                             |
