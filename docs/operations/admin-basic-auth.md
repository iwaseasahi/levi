...
3. Select **管理者を招待**.
4. Levi sends a 72-hour password setup link to the email address. It never
...
their email address, and receives a 72-hour reset link. The response is the same
...
- Invitation and reset links expire after 72 hours and cannot be reused.
