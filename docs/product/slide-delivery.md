...
| Decide delimiter/EOL/preview/search                                | [Golden examples and search contract](slide-contract.md#page-parsing-outline-and-preview); #383–#385                                                                                            |
| Explicit church aggregate, FK/check/index/delete                   | [ADR 0015](../architecture/0015-church-owned-slides.md); #382, #388                                                                                                                             |
| Separate shared presentation and slide domain                      | ADR 0015 and [projection contract](slide-contract.md#projection-and-page-operation); #386, #387                                                                                                 |
