...
| [#385](https://github.com/iwaseasahi/levi/issues/385) | feat: スライド本文検索・最近の更新・cursor paginationを実装する（検索/recentは後に#397で削除） | #382, #383             |
...
Implementation children delivered schema, domain, CRUD/preview, list,
...
legacy Slide import, production capacity or Sunday measurement. The unused
search/recent API is removed by #397; #302 remains an explicit capacity
follow-up. #59's earlier closure meant decomposition, not this acceptance.
