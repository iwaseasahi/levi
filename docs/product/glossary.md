...
| Church user       | An independently authenticated account belonging to exactly one church and allowed to use that church's protected data.      | Confirmed in Issues #38 and #357.                                      |
...
| Pinned folder     | A church-owned folder deliberately displayed ahead of non-pinned folders without changing either group's explicit order.     | Confirmed retained behavior in Issues #38 and #228.                    |
| Current folder    | The displayed folder most recently selected directly or through one of its bookmarks; it reopens without moving in the menu. | Confirmed replacement semantics in Issues #228 and #497.               |
