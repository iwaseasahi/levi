...
| Controller window    | The latest-Chrome window containing search results, presentation controls, and audience-window status.                           | Confirmed for the initial release in Issue #38.                        |
| Audience window      | A separate latest-Chrome window containing only content and display state intended for attendees.                                | Confirmed for the initial release in Issue #38.                        |
...
| Presentation         | The synchronized controller/audience state for the current Bible location, translation selection, font, scroll, and blank state. | Confirmed for the initial release.                                     |
