...
| Audience stale or unauthorized text   | Direct audience tab and authenticated scripture APIs                  | Canonical coordinates only in URL, no verse text in URL, periodic/visibility session checks, fail-closed text removal, direct-tab E2E                                                                                                  | Same-session latest-Chrome scope is retained                                                    |
