...
| Local subscription agent handoff/review | [#2](https://github.com/iwaseasahi/levi/issues/2)   | [#36](https://github.com/iwaseasahi/levi/pull/36) |
...
| A fresh agent can set up without oral context                      | [`AGENTS.md`](../../AGENTS.md) is the provider-neutral contract; [`README.md`](../../README.md) documents pinned requirements, clean setup, canonical commands, and instruction discovery. A fresh branch clone passed frozen install, documented `.env.example` setup, and `pnpm check` on 2026-08-21. |
