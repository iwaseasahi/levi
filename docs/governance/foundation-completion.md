...
| A fresh agent can set up without oral context                      | [`AGENTS.md`](../../AGENTS.md) is the provider-neutral contract; [`README.md`](../../README.md) documents pinned requirements, clean setup, canonical commands, and instruction discovery.                                                                  |
