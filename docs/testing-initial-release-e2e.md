...
| Separate audience window and synchronization | The scripture flow opens a real popup and checks that audience-only content follows direct, next, and previous selection.                                                       |
