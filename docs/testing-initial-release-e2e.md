...
| Folder and bookmark lifecycle                     | `scripture-saved-content.spec.ts` creates, pins, marks current, renames, reorders, reopens the current folder across navigation, deletes a bookmark, and physically deletes its folder.     |
